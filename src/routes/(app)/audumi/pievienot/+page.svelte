<script lang="ts">
	...
	let { data }: { data: { form: SuperValidated<Infer<MaterialSchema>> } } = $props();
	...
	<div class="max-h-[90vh] w-full max-w-md overflow-hidden rounded-lg">
		<Card.Root class="custom-scroll relative max-h-[90vh] w-full max-w-md gap-2 overflow-y-auto">
			<Card.Header>
				...
				<h2 class="text-lg font-semibold">Pievienot jaunu audumu</h2>
			</Card.Header>
										...
										<div class="flex items-center gap-3">
											<div class="relative h-[100px] w-[100px]">
												<img
													src={imagePath}
													alt="preview"
													class="corner-lg h-[100px] w-[100px] object-contain"
												/>
